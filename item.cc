...
void Item::itemEffect(GameObject *character, bool player) {
	switch (_item) {
		case 0:
			if(player) cout<< "You chug the Retore Health potion." << endl;
			character->setHealth(30);
			break;
		case 1:
			if(player) cout<< "You chug the Boost Atk potion." << endl;
			character->setAttack(30);
			break;
		case 2:
			if(player) cout<< "You chug the Boost Def potion." << endl;
			character->setDefense(30);
			break;
		case 3:
			if(player) cout<< "You chug the Poison Health potion." << endl;
			character->setHealth(-15);
			break;
		case 4:
			if(player) cout<< "You chug the Wound Atk potion." << endl;
			character->setAttack(-5);
			break;
		case 5:
			if(player) cout<< "You chug the Wound Def potion." << endl;
			character->setDefense(-5);
			break;
		case 6:
			if(player) cout << "You pick up the Gold Pile worth 10GP." << endl;
			character->setGold(10);
			break;
		case 7:
			if (canPickup()) {
				if(player) cout << "You successfully take the Dragon Hoard!" << endl;
